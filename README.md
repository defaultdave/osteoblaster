...
```
          ...
          ╔══════════════════════════════════════════════╗
          ║   Building bone from what works.             ║
          ║   Scaffolding Claude Code agent systems.     ║
          ╚══════════════════════════════════════════════╝
...
Reusable prompt patterns referenced during `/ossify`:
...
3. **Examples, not templates** — Examples show what good looks like. `/ossify` generates fresh configs aligned to current best practices.
