...
- **Review**: `@review` audits diff for bugs, security, financial logic, scope compliance
...
| Agent | Purpose | Model |
|-------|---------|-------|
| `@senior` | Implementation — writes production code and tests | claude-sonnet-4-20250514 |
| `@review` | Code review — audits for bugs, security, financial logic, scope compliance | claude-haiku-4-5-20251001 |
| `@qa` | QA — runs tests, runtime verification, posts evidence | claude-sonnet-4-20250514 |
| `@tech-pm` | Planning — triages, decomposes, estimates (no code) | claude-haiku-4-5-20251001 |
...
7. **Financial calculations require tests.** Any function computing allocations, returns, fees, or risk scores must have deterministic unit tests.
