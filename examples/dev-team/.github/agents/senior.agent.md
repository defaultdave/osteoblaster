---
name: senior
description: Implements features and fixes bugs with production-quality TypeScript. Assign issues labeled "implementation" or use for feature requests and bug fixes.
